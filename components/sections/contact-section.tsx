...
export default function ContactSection() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // Simulate form submission functionality will be added later
    setTimeout(() => {
      console.log(values);
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Feel free to reach out through the form or use my contact details below.
              </p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">rajeshpadhi2000@gmail.com</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+91 8339944069</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
